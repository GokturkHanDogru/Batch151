...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getSquareOfLenghtsOfWords(iller));

        System.out.println(printOddNumberWords(iller));
    ...
    public static List<Integer> getSquareOfLenghtsOfWords (List<String> iller){
       return iller.
               stream().
    ...
    public static List<String> printOddNumberWords (List<String>iller){

        return iller.stream().filter(t-> t.length()%2==0).collect(Collectors.toList());
    }
