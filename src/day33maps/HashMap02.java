...
public class HashMap02 {
 ...
 birbirine benzemeyen kodlar uretir, ornegin bunun icin 34 uretiyor. Java key icin 34 hashcode uretti.
...
entry olsa da 82'yi secer ancak hashcode'a dokunmayan java Ankara yerine Istanbul yazar.
    ...
    public static void main(String[] args) {
        ...
        //HashMap arkasindaki Mekanizma nasil calisir
        HashMap<String,String> capitals = new HashMap<>();

        capitals.put("USA","Washington");
        capitals.put("Italy","Rome");
        capitals.put("Türkiye","Ankara");
        capitals.put("Türkiye","Istanbul");
    }
}
